...
Virtual Box subtracts 3MB from the emulator's detected RAM, so I increased it to 19MB to appear as 16MB. Depending on how much RAM is actually being used, I included both figures to help you decide how much is actually needed. 5MB of VRAM was selected (on 32 Bit Birtual Box)
